...
The goal of TDC is to classify timeseries data into one of 13 behaviours:
G: Growth
D: Decline
E: Equilibrium
...
You can install the development version of TDC from [GitHub](https://github.com/) with:
